<!-- var csssetting=['text-primary text-font3','text-light text-font3',['py-sm'],['bg-lightB','h-4','w-border'],false]  -->
<script setup>
...
<template>
  <div class="containerB">
    <div v-for="choice,index in choices" :key="choice" class="flex items-center">
        <div v-if="blankBox[index] && csssetting[4]" :class="csssetting[3]"></div>
