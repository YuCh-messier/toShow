  ...
  var handleFilter = function handleFilter(value2) {
    ...
    if (filter && isFunction_1(filter)) {
      if (Array.isArray(tmpPropOptions)) {
        ...
        filteredOptions = Object.values(valueToOption).filter(function (option) {
          return filter(value2, option);
        });
      }
      ...
      return function (_ref4) {
        ...
        return val.slice(0, minCollapsedNum ? minCollapsedNum : val.length).map(function (v, key) {
          ...
          return /* @__PURE__ */React.createElement(Tag, _objectSpread(_objectSpread({
            key: key,
            closable: !(filterOption !== null && filterOption !== void 0 && filterOption.disabled) && !disabled
          }, tagProps), {}, {
            onClose: function onClose(_ref5) {
              var _tagProps$onClose;

              var e = _ref5.e;
              e.stopPropagation();
              var values = getSelectValueArr(value, value[key], true, valueType, keys);
              onChange(values, null);
              tagProps === null || tagProps === void 0 ? void 0 : (_tagProps$onClose = tagProps.onClose) === null || _tagProps$onClose === void 0 ? void 0 : _tagProps$onClose.call(tagProps, {
                e: e
              });
            }
          }), v);
