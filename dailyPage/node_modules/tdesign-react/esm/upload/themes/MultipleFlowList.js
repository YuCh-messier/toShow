...
var ImageFlowList = function ImageFlowList(props) {
  ...
  var renderStatus = function renderStatus(file) {
    ...
    }, iconMap[file.status], /* @__PURE__ */React.createElement("span", null, textMap[file.status], file.status === "progress" ? " ".concat(file.percent, "%") : ""));
  };
  ...
  var renderFileList = function renderFileList() {
    ...
    return /* @__PURE__ */React.createElement("table", _objectSpread({
      ...
      var fileName = (_props$abridgeName = props.abridgeName) !== null && _props$abridgeName !== void 0 && _props$abridgeName.length ? abridgeName(file.name, props.abridgeName[0], props.abridgeName[1]) : file.name;
      return /* @__PURE__ */React.createElement("tr", {
        key: file.name + index
      }, /* @__PURE__ */React.createElement("td", null, file.url ? /* @__PURE__ */React.createElement(Link, {
        href: file.url,
        target: "_blank",
        hover: "color"
      }, fileName) : fileName), /* @__PURE__ */React.createElement("td", null, returnFileSize(file.size)), /* @__PURE__ */React.createElement("td", null, renderStatus(file)), disabled ? null : deleteNode);
    })));
  };
