...
import '../../_chunks/dep-2d0c808f.js';
...
var ImageCard = function ImageCard(props) {
  ...
  var renderProgressFile = function renderProgressFile(file, loadCard) {
    ...
    return /* @__PURE__ */React.createElement("div", {
      ...
      loading: true,
      size: "medium"
    }), /* @__PURE__ */React.createElement("p", null, locale === null || locale === void 0 ? void 0 : (_locale$progress = locale.progress) === null || _locale$progress === void 0 ? void 0 : _locale$progress.uploadingText, props.showUploadProgress ? " ".concat(file.percent, "%") : ""));
  };
  ...
  return /* @__PURE__ */React.createElement("div", null, /* @__PURE__ */React.createElement("ul", {
    ...
    return /* @__PURE__ */React.createElement("li", {
      ...
      key: index
    }, file.status === "progress" && renderProgressFile(file, loadCard), file.status === "fail" && renderFailFile(file, index, loadCard), !["progress", "fail"].includes(file.status) && file.url && renderMainContent(file, index), /* @__PURE__ */React.createElement("div", {
      className: "".concat(classPrefix, "-upload__card-name")
    }, file.name));
  ...
  }, locale === null || locale === void 0 ? void 0 : (_locale$triggerUpload = locale.triggerUploadText) === null || _locale$triggerUpload === void 0 ? void 0 : _locale$triggerUpload.image)))));
};
