...
import { _ as _objectWithoutProperties } from './dep-fe234c83.js';
import { _ as _defineProperty } from './dep-ebef14de.js';
import { _ as _slicedToArray } from './dep-2baf8638.js';
import React, { useState, useEffect, useCallback } from 'react';
import { i as isArray_1 } from './dep-342e02ed.js';
import { i as isFunction_1 } from './dep-f2b0265c.js';
import { CloseIcon, ImageErrorIcon, MirrorIcon, RotationIcon, ImageIcon } from 'tdesign-icons-react';
...
var ImageModelMiniContent = function ImageModelMiniContent(props) {
  ...
  }, /* @__PURE__ */React.createElement(ImageModelItem, {
...
var ImageModelMini = function ImageModelMini(props) {
  ...
  }, /* @__PURE__ */React.createElement("span", null, title), "".concat(index + 1, "/").concat(images.length), /* @__PURE__ */React.createElement("span", {
  ...
  }, /* @__PURE__ */React.createElement(ImageModelMiniContent, _objectSpread({}, props)));
};
...
var ImageModelItem = function ImageModelItem(_ref) {
  ...
  return /* @__PURE__ */React.createElement("div", {
    ...
    style: boxStyle
  }, error && /* @__PURE__ */React.createElement(ImageError, null), !error && !!preSrc && /* @__PURE__ */React.createElement("img", {
...
var ImageViewerUtils = function ImageViewerUtils(_ref3) {
  ...
  }))), /* @__PURE__ */React.createElement(ImageModelIcon, {
    size: "medium",
    name: "zoom-out",
    onClick: onZoomOut
  }), /* @__PURE__ */React.createElement(ImageModelIcon, {
  ...
  }))), currentImage.download && /* @__PURE__ */React.createElement(ImageModelIcon, {
    size: "medium",
    name: "download",
    onClick: function onClick() {
...
var ImageModal = function ImageModal(props) {
  ...
  if (isMini) {
    return /* @__PURE__ */React.createElement(ImageModelMini, {
      visible: visible,
      draggable: draggable,
      index: index,
      images: images,
  ...
  if (closeBtn === true) {
    closeNode = /* @__PURE__ */React.createElement(ImageModelIcon, {
      name: "close",
      size: "24px",
  ...
  return /* @__PURE__ */React.createElement("div", {
  ...
  }, /* @__PURE__ */React.createElement("span", null, title), "".concat(index + 1, "/").concat(images.length)), /* @__PURE__ */React.createElement(ImageModelIcon, {
    size: "24px",
    name: "chevron-left",
    ...
    onMirror: onMirror,
    onReset: onReset
  }), closeNode, /* @__PURE__ */React.createElement(ImageModelItem, {
    scale: scale,
    rotateZ: rotateZ,
    mirror: mirror,
...
export { ImageModal as I, ImageModelMiniContent as a, ImageModelMini as b, ImageModelItem as c, ImageViewerUtils as d };
//# sourceMappingURL=dep-2d0c808f.js.map
