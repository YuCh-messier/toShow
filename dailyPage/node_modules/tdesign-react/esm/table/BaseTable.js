...
import { p as pick_1 } from '../_chunks/dep-17055df6.js';
...
var BaseTable = /*#__PURE__*/forwardRef(function (props, ref) {
  var _tableClasses$concat, _props$data2, _props$scroll3, _props$scroll4, _tableContentRef$curr;
  ...
  var renderFixedHeader = function renderFixedHeader() {
    var _navigator, _affixHeaderRef$curre;
    ...
    }, colgroup, props.showHeader && /* @__PURE__ */React.createElement(THead, _objectSpread({}, headProps))));
  ...
  var renderAffixedHeader = function renderAffixedHeader() {
    ...
    return !!(isVirtual || props.headerAffixedTop) && (props.headerAffixedTop ? /* @__PURE__ */React.createElement(Affix, _objectSpread(_objectSpread({
      offsetTop: 0
  ...
  }, colgroup, props.showHeader && /* @__PURE__ */React.createElement(THead, _objectSpread({}, headProps)), /* @__PURE__ */React.createElement(TBody, _objectSpread({}, tableBodyProps)), /* @__PURE__ */React.createElement(TFoot, {
    rowKey: props.rowKey,
    isFixedHeader: isFixedHeader,
    rowAndColFixedPosition: rowAndColFixedPosition,
    footData: props.footData,
  ...
  }, topContent), renderAffixedHeader(), tableContent, renderAffixedFooter(), loadingContent, showRightDivider && /* @__PURE__ */React.createElement("div", {
