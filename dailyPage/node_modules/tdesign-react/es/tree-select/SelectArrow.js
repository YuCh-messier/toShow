...
var SelectArrow = function SelectArrow(_ref) {
  ...
  return /* @__PURE__ */React.createElement(FakeArrow, {
    isActive: isActive,
    disabled: disabled,
    overlayClassName: classNames((_classNames = {}, _defineProperty(_classNames, "".concat(classPrefix, "-fake-arrow--highlight"), isHighlight), _defineProperty(_classNames, "".concat(classPrefix, "-fake-arrow--disable"), disabled), _classNames))
  });
};
