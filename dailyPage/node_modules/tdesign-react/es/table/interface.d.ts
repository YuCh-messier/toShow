 ...
 */
export declare type SimpleTableProps<T extends TableRowData = TableRowData> = BaseTableProps<T>;
...
export declare type BaseTableColumns<T extends TableRowData = TableRowData> = TdBaseTableProps<T>['columns'];
...
export declare type RowAndColFixedPosition<T extends TableRowData = TableRowData> = Map<string | number, FixedColumnInfo<T>>;
export interface RecalculateColumnWidthFunc<T extends TableRowData = TableRowData> {
    (columns: BaseTableCol<T>[], thWidthList: {
