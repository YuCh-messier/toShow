...
var DraggerFile = function DraggerFile(props) {
  ...
  var renderMainPreview = function renderMainPreview() {
    var file = displayFiles[0];
    if (!file) return null;
    var fileName = props.abridgeName ? abridgeName(file.name, props.abridgeName[0], props.abridgeName[1]) : file.name;
    return /* @__PURE__ */React.createElement("div", {
      ...
      className: "".concat(SIZE.small)
    }, locale.file.fileOperationDateText, "\uFF1A", file.uploadTime || "-"), /* @__PURE__ */React.createElement("div", {
