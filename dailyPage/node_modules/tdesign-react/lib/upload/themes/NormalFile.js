...
function NormalFile(props) {
  ...
  var renderFilePreviewAsInput = function renderFilePreviewAsInput() {
    ...
    var fileName = (_props$abridgeName = props.abridgeName) !== null && _props$abridgeName !== void 0 && _props$abridgeName.length && file !== null && file !== void 0 && file.name ? abridgeName(file.name, props.abridgeName[0], props.abridgeName[1]) : file === null || file === void 0 ? void 0 : file.name;
    return /* @__PURE__ */React.createElement("div", {
  ...
  }, props.sizeOverLimitMessage), !props.multiple && ((_displayFiles$ = displayFiles[0]) === null || _displayFiles$ === void 0 ? void 0 : _displayFiles$.status) === "fail" && theme === "file" ? /* @__PURE__ */React.createElement("small", {
    className: classNames(props.errorClasses)
