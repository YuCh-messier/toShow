...
import { i as isNumber_1 } from '../../_chunks/dep-04fa7e7c.js';
import setThWidthListByColumnDrag from '../../_common/js/table/set-column-width-by-drag.js';
import recalculateColumnWidth from '../../_common/js/table/recalculate-column-width.js';
...
function useColumnResize(tableContentRef, refreshTable, getThWidthList, updateThWidthList) {
  var resizeLineRef = useRef();
  var notCalculateWidthCols = useRef([]);
