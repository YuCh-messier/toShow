...
var Input = forwardRefWithStatics(function (props, ref) {
  ...
  useIsomorphicLayoutEffect(function () {
    requestAnimationFrame(function () {
      ...
      inputRef.current.style.width = "".concat((_inputPreRef$current = inputPreRef.current) === null || _inputPreRef$current === void 0 ? void 0 : _inputPreRef$current.offsetWidth, "px");
    });
  ...
  }, value || placeholder), suffixContent ? /* @__PURE__ */React.createElement("div", {
