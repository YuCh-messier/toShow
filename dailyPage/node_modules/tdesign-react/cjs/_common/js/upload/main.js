...
var unsupportedIterableToArray = require('../../../_chunks/dep-789d4bfb.js');
...
function _toArray(arr) {
  return slicedToArray._arrayWithHoles(arr) || toConsumableArray._iterableToArray(arr) || unsupportedIterableToArray._unsupportedIterableToArray(arr) || slicedToArray._nonIterableRest();
}
...
function handleRequestMethodResponse(res) {
  ...
  if (res.status === "success" && (!res.response || !res.response.url)) {
    _common_js_log_log["default"].warn("Upload", "`requestMethodResponse.response.url` is required as `status` is `success`");
  }
