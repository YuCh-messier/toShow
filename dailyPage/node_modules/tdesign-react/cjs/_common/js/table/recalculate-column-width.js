...
var setMissingColumnWidth = function setMissingColumnWidth(columns, missingWidthCols, thWidthList, tableLayout, actualWidth, tableWidth) {
  ...
  if (actualWidth < tableWidth) {
    ...
    missingWidthCols.forEach(function (col) {
      var minWidth = _common_js_table_utils.getColWidthAttr(col, "minWidth");
    ...
    missingWidthCols.forEach(function (col) {
      thMap[col.colKey] = _common_js_table_utils.getColWidthAttr(col, "minWidth") || 100;
    });
  } else {
    var extraWidth = 0;
    missingWidthCols.forEach(function (col) {
      extraWidth += _common_js_table_utils.getColWidthAttr(col, "minWidth") || 100;
    });
    var totalWidth = extraWidth + actualWidth;
    columns.forEach(function (col) {
      if (!thMap[col.colKey]) {
        var colWidth = _common_js_table_utils.getColWidthAttr(col, "minWidth") || 100;
...
function recalculateColumnWidth(columns, thWidthList, tableLayout, tableElmWidth, notCalculateWidthCols, callback) {
  ...
  columns.forEach(function (col) {
    if (!thWidthList[col.colKey]) {
      thMap[col.colKey] = _common_js_table_utils.getColWidthAttr(col, "width");
    } else {
...
exports["default"] = recalculateColumnWidth;
