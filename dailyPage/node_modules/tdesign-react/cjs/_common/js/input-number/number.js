...
function canAddNumber(num, max) {
  ...
  if (largeNumber && isString.isString_1(num)) {
...
function formatToNumber(num, extra) {
  ...
  var isLargeNumber = (extra === null || extra === void 0 ? void 0 : extra.largeNumber) && isString.isString_1(num);
  var newNumber = num;

  if (isString.isString_1(num) && num.includes("e") || isNumber.isNumber_1(num)) {
    newNumber = isLargeNumber ? _common_js_inputNumber_largeNumber.formatENumber(num) : Number(num);
  }

  if ((extra === null || extra === void 0 ? void 0 : extra.decimalPlaces) !== void 0) {
    newNumber = _common_js_inputNumber_largeNumber.largeNumberToFixed(newNumber, extra.decimalPlaces, extra.largeNumber);
  }
...
function putInRangeNumber(val, params) {
  ...
  if (largeNumber && (isString.isString_1(max) || max === Infinity) && (isString.isString_1(min) || min === -Infinity)) {
...
function getStepValue(p) {
  ...
  var tStep = isNumber.isNumber_1(step) ? String(step) : step;
  var newVal;

  if (op === "add") {
    if (largeNumber && isString.isString_1(lastValue)) {
...
function getMaxOrMinValidateResult(p) {
  ...
  if (largeNumber && isNumber.isNumber_1(value)) {
