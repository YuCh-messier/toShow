...
var toInteger$1 = require('../../../_chunks/dep-de26ea20.js');
var _baseSlice = require('../../../_chunks/dep-6d1aecc8.js');
...
function isSameWeek(date1, date2) {
  return isSameMonth(date1, date2) && dayjs__default["default"](date1).week() === dayjs__default["default"](date2).week();
}
  ...
  if (showWeekOfYear) {
    dataList.forEach(function (d) {
      d.unshift(_objectSpread(_objectSpread({}, d[0]), {}, {
        active: false,
        value: d[0].value,
        text: dayjs__default["default"](d[0].value).week()
      }));
    });
  }
...
function isEnabledDate(_ref9) {
  ...
  if (max && min) {
    ...
    isEnabled = dayjs__default["default"](value).isBetween(_compareMin, _compareMax, mode, "[]");
  } else if (min) {
    var _compareMin2 = dayjs__default["default"](new Date(min));

    isEnabled = !dayjs__default["default"](value).isBefore(_compareMin2, mode);
  } else if (max) {
    var _compareMax2 = dayjs__default["default"](new Date(max));

    isEnabled = !dayjs__default["default"](value).isAfter(_compareMax2, mode);
  }
