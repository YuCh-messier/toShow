...
var isPlainObject = require('../../../_chunks/dep-6aeda844.js');
...
var TreeStore = /*#__PURE__*/function () {
  ...
  createClass._createClass(TreeStore, [{
    key: "initNullNodeModel",
    value: function initNullNodeModel() {
      var nullNode = new _common_js_tree_treeNode.TreeNode(this, {
        value: "",
        label: "",
        children: []
      });
    ...
    value: function getNodes(item, options) {
      ...
      if (options) {
        ...
        if (isPlainObject.isPlainObject_1(conf.props)) {
          nodes = nodes.filter(function (node) {
    ...
    value: function replaceExpanded(list) {
      ...
      var added = difference.difference_1(list, expanded);
      var removed = difference.difference_1(expanded, list);
    ...
    value: function emit(name, state) {
      ...
      var methodName = camelCase.camelCase_1("on-".concat(name));
