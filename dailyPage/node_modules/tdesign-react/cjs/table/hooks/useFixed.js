...
function getColumnFixedStyles(col, index, rowAndColFixedPosition, tableColFixedClasses) {
  ...
  if (!fixedPos) return {};
  var thClasses = (_thClasses = {}, defineProperty._defineProperty(_thClasses, tableColFixedClasses.left, col.fixed === "left"), defineProperty._defineProperty(_thClasses, tableColFixedClasses.right, col.fixed === "right"), defineProperty._defineProperty(_thClasses, tableColFixedClasses.lastLeft, col.fixed === "left" && fixedPos.lastLeftFixedCol), defineProperty._defineProperty(_thClasses, tableColFixedClasses.firstRight, col.fixed === "right" && fixedPos.firstRightFixedCol), _thClasses);
  var thStyles = {
...
function getRowFixedStyles(rowId, rowIndex, rowLength, fixedRows, rowAndColFixedPosition, tableRowFixedClasses) {
  ...
  var rowClasses = (_rowClasses = {}, defineProperty._defineProperty(_rowClasses, tableRowFixedClasses.top, fixedTop), defineProperty._defineProperty(_rowClasses, tableRowFixedClasses.bottom, fixedBottom), defineProperty._defineProperty(_rowClasses, tableRowFixedClasses.firstBottom, rowIndex === firstFixedBottomRow), defineProperty._defineProperty(_rowClasses, tableRowFixedClasses.withoutBorderBottom, rowIndex === firstFixedBottomRow - 1), _rowClasses);
  var rowStyles = {
...
function useFixed(props, finalColumns) {
  ...
  var setFixedRowPosition = function setFixedRowPosition(trList, initialColumnMap, thead, tfoot) {
    ...
    for (var i = 0; i < fixedTopRows; i++) {
      ...
      var tr = trList[i];
      var rowId = get.get_1(data2[i], rowKey);
      var thisRowInfo = initialColumnMap.get(rowId) || {};
      var lastRowId = get.get_1(data2[i - 1], rowKey);
    ...
    for (var _i = data2.length - 1; _i >= data2.length - fixedBottomRows; _i--) {
      ...
      var _rowId = get.get_1(data2[_i], rowKey);

      var _thisRowInfo = initialColumnMap.get(_rowId) || {};

      var _lastRowId = get.get_1(data2[_i + 1], rowKey);
  ...
  var refreshTable = hooks_useDebounce["default"](function () {
    updateTableWidth();
    updateFixedHeader();
  ...
  function addTableResizeObserver(tableElement) {
    ...
    _util_dom.off(window, "resize", onResize);
  ...
  React.useEffect(function () {
    var scrollWidth = _common_js_utils_getScrollbarWidth["default"]();
    ...
    var timer = setTimeout(function () {
      ...
      if (isWatchResize && _common_js_utils_helper.getIEVersion() < 11 || typeof window.ResizeObserver === "undefined") {
        _util_dom.on(window, "resize", onResize);
      }
